    ...
    <div class="container">
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Password" name="bio" id="bio" value={{$userInfo->bio}}>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control"  placeholder="address" name="address" id="address" value={{$userInfo->address}}>
                </div>
            </div>
            <div class="form-group">
