	    					...
	    					<div class="cardbox">
				 				<div class="cardbox-heading">
				  				...
				  				<div class="cardbox-item">
				  					<p style="margin-left: 10px;">{{$post[$i]->post_text}}</p>
			          			...
			          			<ul class="img-comment-list" style="width: 100%; margin-left: 10px">
	             					<li>
							 	...
							 	<ul style="width: 100%; height: 40px">
								  	<li>
								   		<span class="thumb-xs">
											<img style="margin-top: 2px" class="img-responsive img-circle" src="" alt="Image">
								   		</span>
								   		<div class="comment-body" style="width: 95%; display:inline-flex;">
								   			<form method="Post">
								   				<input class="form-control input-sm" type="text" name="comment" placeholder="Write your comment..." style="width: 95%">
								   				<input type="hidden" name="post_id" value="">
									 			<button class="kafe-btn kafe-btn-mint-small pull-right btn-sm" type="submit" style="width: 60px; margin-left: 10px" >Post</button>
								   			</form>
								   		</div><!--/ comment-body -->	
					              	</li>				
				             	</ul>				
          				...
          				<div class="col-md-4 modal-meta">
	           				<div class="modal-meta-top">
					            ...
					            <div class="modal-meta-bottom">
								 	<ul>
									  	<li>
									  		<a class="modal-like" href="#"><i class="fa fa-heart"></i>
									  		</a>
									  			<span class="modal-one"> 786,286</span> | 
									      	<a class="modal-comment" href="#"><i class="fa fa-comments"></i>
									      	</a>
									      		<span> 786,286</span>
									    </li>
									  	<li>
...
<!-- Mirrored from themashabrand.com/templates/Fluffs//home by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Feb 2020 18:07:31 GMT -->
</html>
